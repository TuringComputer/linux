...
#ifdef CONFIG_SND_STG3856_CONTROLS_FOR_SGTL5000
	#include <sound/stg3856-audiomux.h>
#endif

#ifdef CONFIG_SND_STA309A_CONTROLS_FOR_SGTL5000
...
#ifdef CONFIG_SND_STG3856_CONTROLS_FOR_SGTL5000
	ret = stg3856_audiomux_add_controls(codec);
    if (ret < 0)
	    return ret;
#endif

#ifdef CONFIG_SND_STA309A_CONTROLS_FOR_SGTL5000
	ret = sta309a_audiodsp_add_controls(codec);
    if (ret < 0)
	    return ret;
#endif
