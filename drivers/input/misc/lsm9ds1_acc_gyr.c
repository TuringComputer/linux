...
static struct kobj_attribute poll_attr_acc =
	__ATTR(pollrate_ms, S_IWUSR | S_IRUGO, attr_get_polling_rate_acc, 
						attr_set_polling_rate_acc);
static struct kobj_attribute enable_attr_acc =
	__ATTR(enable_device, S_IWUSR | S_IRUGO, attr_get_enable_acc, attr_set_enable_acc);
static struct kobj_attribute fs_attr_acc =
	__ATTR(range, S_IWUSR | S_IRUGO, attr_get_range_acc, attr_set_range_acc);
static struct kobj_attribute aa_filter_attr  =
	__ATTR(anti_aliasing_frequency, S_IWUSR | S_IRUGO, attr_get_aa_filter, 
							attr_set_aa_filter);
static struct kobj_attribute poll_attr_gyr =
	__ATTR(pollrate_ms, S_IWUSR | S_IRUGO, attr_get_polling_rate_gyr, 
						attr_set_polling_rate_gyr);
static struct kobj_attribute enable_attr_gyr =
	__ATTR(enable_device, S_IWUSR | S_IRUGO, attr_get_enable_gyr, attr_set_enable_gyr);
static struct kobj_attribute range_attr_gyr =
	__ATTR(range, S_IWUSR | S_IRUGO, attr_get_range_gyr, attr_set_range_gyr);
