...
#define REG_SW_3_4_5_MASK	(SW3_MODE_MASK | SW4A_MODE_MASK	| SW4B_MODE_MASK | SW5_MODE_MASK)
#define REG_SW_3_4_5_VALUE	(SW3_MODE_VALUE | SW4A_MODE_VALUE | SW4B_MODE_VALUE | SW5_MODE_VALUE)
